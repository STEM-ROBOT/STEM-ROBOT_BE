...
builder.Services.AddCors(options =>
{
    ...
    {
        policy.WithOrigins("http://localhost:5173", "http://localhost:3000", "http://157.66.27.69:5173", "http://stemsystem.io.vn:5173", "http://stemsystem.io.vn", "http://10.4.0.203:8081")
                 .AllowAnyHeader()
                 .AllowAnyMethod()
                    .AllowCredentials();
